...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permission_scope'], function (Blueprint $table) {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) use ($tableNames) {
            ...
            $table->integer('order')->nullable();
            $table->timestamps();
            $table->foreign('scope_id','permission_menu_scope_id_foreign')->references('id')->on($tableNames['permission_scope'])->onDelete('cascade')->onUpdate('cascade');
