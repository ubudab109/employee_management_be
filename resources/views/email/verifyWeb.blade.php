...
<p>
    {{__('You have been invited to be the manager of the EMS website as ')}} {{ $user['role']}} {{__('. Please click on the verification link below to log into the website and here are your credentials:')}}
</p>
<p>
    {{__('Email : ')}} {{$user['email']}}
</p>
