                            ...
                            <tr>
                                <td valign="top">
                                    <div mc:edit="header_logo">
                                        <a href="#">
                                            <img @if(!empty(allCompanySetting()['company_logo'])) src="{{asset('company-logo/'.allCompanySetting()['company_logo']) }}" @else src="{{asset('assets/images/logo.png')}}" @endif alt="" style="width:25%;">
                                        </a>
                                    </div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td align="center" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" mc:repeatable="banner" mc:variant="banner" style="text-align: center;">
                            <tr>
                                <td valign="top">
                                    <h2 style="margin-bottom: 0;font-size: 30px;color: #fff;">{{__('Welcome to')}} {{ allCompanySetting('company_name')}}</h2>
